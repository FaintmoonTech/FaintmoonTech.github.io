<template>
    <div class="page" :style="pageStyle">
        <img src="../assets/bg1.jpg" class="bg" :style="{opacity: 2 * scrollY - 19.5}" />
        <img src="../assets/bg2.jpg" class="bg" :style="{opacity: 2 * scrollY - 21.5}" />
        <img src="../assets/bg3.jpg" class="bg" :style="{opacity: 2 * scrollY - 23.5}" />
        <img src="../assets/bg4.jpg" class="bg" :style="{opacity: 2 * scrollY - 25.5}" />
        <img src="../assets/bg5.jpg" class="bg" :style="{opacity: 2 * scrollY - 27.5}" />
        <img src="../assets/bg6.jpg" class="bg" :style="{opacity: 2 * scrollY - 29.5}" />
        <img src="../assets/bg7.jpg" class="bg" :style="{opacity: 2 * scrollY - 31.5}" />
        <img src="../assets/bg8.jpg" class="bg" :style="{opacity: 2 * scrollY - 33.5}" />
        <p class="title">
            时空旅行
        </p>
        <p class="subtitle">
